...
public class CatanMap {
    ...
    private void populateRandomHexes() {
        ...
        ArrayList<Hex> hexes = this.hexes.values().stream()
                .filter(h -> (((h.getLocation().getY() < 3) && (h.getLocation().getY() > -3)) && (
                        (h.getLocation().getX() < 3) && (h.getLocation().getX() > -3)) && Math.abs(h.getLocation().getX() + h.getLocation().getY()) != 3))
    ...
    private void populateRandomPorts() {
        ...
        ArrayList<Hex> hexes = this.hexes.values().stream()
                .filter(h -> !(((h.getLocation().getY() < 3) && (h.getLocation().getY() > -3)) && (
                        (h.getLocation().getX() < 3) && (h.getLocation().getX() > -3)) && Math.abs(h.getLocation().getX() + h.getLocation().getY()) != 3)).collect(Collectors.toCollection(ArrayList::new));
        //randomize who gets what number
        Collections.shuffle(hexes);
