 ...
 * for a new game
 */
@SuppressWarnings("serial") public class NewGameView extends OverlayView implements INewGameView
{
    ...
    @Override public boolean getRandomlyPlaceNumbers()
    {
        return chkRandNumbers.isSelected();
    }

    @Override public void setRandomlyPlaceNumbers(boolean value)
    {
        chkRandNumbers.setSelected(value);
    }

    @Override public boolean getRandomlyPlaceHexes()
    {
        return chkRandHexes.isSelected();
    }

    @Override public void setRandomlyPlaceHexes(boolean value)
    {
        chkRandHexes.setSelected(value);
    }

    @Override public boolean getUseRandomPorts()
    {
        return chkRandPorts.isSelected();
    }

    @Override public void setUseRandomPorts(boolean value)
    {
