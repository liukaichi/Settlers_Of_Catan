 ...
 */
@SuppressWarnings({ "serial", "unused" }) public class WaitView extends OverlayView implements IWaitView
{
    ...
    public WaitView()
    {
        ...
        BufferedImage scaledImage = new BufferedImage(img.getWidth() / 2, img.getHeight() / 2,
