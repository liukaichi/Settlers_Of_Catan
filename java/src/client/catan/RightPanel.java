...
@SuppressWarnings("serial") public class RightPanel extends JPanel
{
    ...
    public RightPanel(final IMapController mapController)
    {
        ...
        devCardController = new DevCardController(playCardView, buyCardView, soldierAction, roadAction);
        ...
        resourceController
                .setElementAction(ResourceBarElement.ROAD, createStartMoveAction(mapController, PieceType.ROAD));
        ...
        resourceController
                .setElementAction(ResourceBarElement.CITY, createStartMoveAction(mapController, PieceType.CITY));
