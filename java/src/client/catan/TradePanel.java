...
@SuppressWarnings("serial") public class TradePanel extends JPanel
{
    ...
    public TradePanel()
    {
        ...
        domesticController = new DomesticTradeController(domesticView, domesticOverlay, domesticWaitView,
        ...
        maritimeController = new MaritimeTradeController(maritimeView, maritimeOverlay);
