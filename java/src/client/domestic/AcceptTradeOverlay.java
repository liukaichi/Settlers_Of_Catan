 ...
 */
@SuppressWarnings("serial") public class AcceptTradeOverlay extends OverlayView implements IAcceptTradeOverlay
{
    ...
    @Override public void addGetResource(ResourceType resource, int amount)
    {
    ...
    @Override public void addGiveResource(ResourceType resource, int amount)
    {
        //Instantiate component on the first addition
    ...
    @Override public void setAcceptEnabled(boolean enable)
    {
        if (enable)
        {
    ...
    @Override public void setPlayerName(String name)
    {
