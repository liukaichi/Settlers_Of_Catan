...
public class DomesticTradeController extends ObserverController implements IDomesticTradeController
{
     ...
     *
     * @param tradeView     Domestic trade view (i.e., view that contains the "Domestic Trade"
     *                      button)
     * @param tradeOverlay  Domestic trade overlay (i.e., view that lets the user propose a
     *                      domestic trade)
     * @param waitOverlay   Wait overlay used to notify the user they are waiting for another
     *                      player to accept a trade
     * @param acceptOverlay Accept trade overlay which lets the user accept or reject a
     *                      proposed trade
     */
    ...
    @Override public void decreaseResourceAmount(ResourceType resource)
    {
        state.decreaseAmount(resource);
    }

    @Override public void increaseResourceAmount(ResourceType resource)
    {
