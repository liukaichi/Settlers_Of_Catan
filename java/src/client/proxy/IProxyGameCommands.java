...
public interface IProxyGameCommands
{
     ...
     * Creates a new game.
     *
     * @param createGameRequest The name and settings to use for the new game. Can be sent as form
     ...
     *
     * @param joinGameRequest The ID of the game the player wants to join, and the color they
     *                        want.
     * @throws GameQueryException if game is not successfully joined.
     * @pre <ol>
     ...
     *
     * @param versionNumber The version number of the client. Input "-1" if you want to grab
     ...
     *
     * @param aiType The type of AI player to add (currently, LARGEST_ARMY is the only
     *               supported type)
     * @throws IllegalArgumentException if the aiType is invalid
     * @throws GameQueryException       if the aiType cannot be added (if the user has not joined a game,
     *                                  or if the game is full).
     * @throws AddAIException           if the aiType cannot be added because the game is full.
     * @pre <ol>
     * <li>The caller has previously logged in to the server and joined a
     * game (i.e., they have valid catan.user and catan.game HTTP cookies).
