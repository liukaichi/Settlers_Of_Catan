...
public interface IProxyDevCardCommands
{
     ...
     *
     * @param soldier Soldier command object.
     ...
     *
     * @param yearOfPlenty Year_of_Plenty command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
     ...
     *
     * @param roadBuilding Road_Building command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
     ...
     *
     * @param monopoly Monopoly command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
     ...
     *
     * @param monument Monument command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
