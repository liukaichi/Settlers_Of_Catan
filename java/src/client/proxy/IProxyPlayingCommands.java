...
public interface IProxyPlayingCommands
{
     ...
     *
     * @param buildRoad buildRoad command object.
     ...
     * player.
     *
     * @param buildSettlement buildSettlement command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
     ...
     * specified player.
     *
     * @param buildCity buildCity command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
    ...
    /**
     * @param offerTrade offerTrade command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
    ...
    /**
     * @param maritimeTrade maritimeTrade command object.
     * @return updated Game model after the command is executed.
     * @pre General Preconditions:
     * <ul>
     * <li>It is your turn.
     ...
     *
     * @param robPlayer robPlayer command object.
     * @return updated Game model after the command is executed.
     * @pre <ul>
     ...
     *
     * @param finishTurn finishTurn command object.
     * @return updated Game model after the command is executed.
     ...
     *
     * @param buyDevCard buyDevCard command object.
     * @return updated Game model after the command is executed.
     * @pre <ul>
     * <li>All /move/* methods also have a common pre'condition in that
     * they assume that the caller has already logged in to the server and
