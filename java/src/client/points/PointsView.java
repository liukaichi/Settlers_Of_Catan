 ...
 */
@SuppressWarnings("serial") public class PointsView extends ComponentView implements IPointsView
{
    ...
    @Override public IPointsController getController()
    {
    ...
    private int drawImages(Graphics2D g2, Image image, float scale, int count, int y)
    {
        ...
        for (int i = 0; i < count; ++i)
        {
            ...
            g2.drawImage(image, x, y, x + scaledImageWidth, y + scaledImageHeight, 0, 0, image.getWidth(null),
