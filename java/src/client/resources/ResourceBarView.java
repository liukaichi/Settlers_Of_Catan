 ...
 */
@SuppressWarnings({ "serial", "unused" }) public class ResourceBarView extends PanelView implements IResourceBarView
{
    ...
    @Override public IResourceBarController getController()
    {
        return (IResourceBarController) super.getController();
    }

    @Override public void setElementEnabled(ResourceBarElement element, boolean enabled)
    {
        resources.get(element).setEnabled(enabled);
    }

    @Override public void setElementAmount(ResourceBarElement element, int amount)
    {
    ...
    private class ResourceElement
    {
        ...
        public ResourceElement(ResourceBarElement type, boolean clickable, BufferedImage elementImage, int elementCount)
        {
        ...
        public ResourceElement(ResourceBarElement type, boolean clickable, boolean enabled, BufferedImage elementImage,
                int elementCount)
        {
            this.initialize();
            this.setElementType(type);
        ...
        private void initialize()
        {
            ...
            _resourceElementPanel.setLayout(new BoxLayout(_resourceElementPanel, BoxLayout.X_AXIS));
        ...
        public void setElementImage(BufferedImage elementImage)
        {
            ...
            double heightScale = (double) IMAGE_SIZE / (double) (elementImage.getHeight(null));
            double widthScale = (double) IMAGE_SIZE / (double) (elementImage.getWidth(null));
            ...
            this._disabledImage = new RescaleOp(scaleFactors, offsetFactors, null).filter(image, null);
            this.update();
        }
