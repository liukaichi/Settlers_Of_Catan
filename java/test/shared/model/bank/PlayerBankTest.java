...
public class PlayerBankTest {
    ...
    public void testBuyRoad() {
        try {
            ...
            assertEquals(1, test.getStructures().getStructure(StructureType.ROAD).getAmount(Structure.AmountType.BUILT));
    ...
    public void testBuySettlement() {
        try{
            ...
            assertEquals(1, test.getStructures().getStructure(StructureType.SETTLEMENT).getAmount(Structure.AmountType.BUILT));
    ...
    public void testBuyCity() {
        try {
            ...
            assertEquals(1, test.getStructures().getStructure(StructureType.CITY).getAmount(Structure.AmountType.BUILT));
            assertEquals(0, test.getStructures().getStructure(StructureType.SETTLEMENT).getAmount(Structure.AmountType.BUILT));
    ...
    @Test
    public void devCardDecksShouldBeEqualAcrossInstances() {
    ...
    @Test
    public void resourcesShouldBeEqualAcrossInstances() {
        PlayerBank test2 = new PlayerBank();
        PlayerBank test3 = new PlayerBank();
