...
public class BankStructureTest
{
    ...
    @Test public void testGetAmount() throws Exception
    {
        BankStructure test = setCity();
    ...
    @Test public void testAddAmount() throws Exception
    {
        BankStructure test = setCity();
    ...
    @Test(expected = Exception.class) public void testAddAmountException() throws Exception
    {
        BankStructure test = setCity();
        test.addAmountBuilt(9);
    }

    @Test public void testSubAmount() throws Exception
    {
    ...
    @Test(expected = CatanException.class) public void testSubAmountException() throws Exception
    {
        BankStructure test = setSettlement();
        test.subAmountBuilt(1);
    }
